...
class SAINTReconstructionHead(keras.layers.Layer):
    ...
    Args:
        reconstruction_blocks: ``List[keras.layers.Layer]``,
            ...
            You can import the ``SAINTRReconstructionHeadBlock`` layer as follows,
                >>> from teras.legacy.layerflow.layers import SAINTReconstructionHeadBlock
    """
    ...
    def get_config(self):
        ...
        config.update({
                          'reconstruction_blocks': serialize_layers_collection(
    ...
    def from_config(cls, config):
        reconstruction_blocks = deserialize_layers_collection(
            config.pop("reconstruction_blocks"))
