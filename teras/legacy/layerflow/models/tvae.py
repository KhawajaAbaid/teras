...
from teras.legacy.losses.tvae import elbo_loss_tvae
from teras.legacy.utils.types import LayerOrModelType
    ...
    Args:
        ...
        encoder: ``keras.layers.Layer`` or ``keras.models.Model``,
            ...
            You can import the ``TVAEEncoder`` as follows,
                >>> from teras.legacy.models import TVAEEncoder
        ...
        decoder: ``keras.layers.Layer`` or ``keras.models.Model``,
            ...
            You can import the ``TVAEDecoder`` as follows,
                >>> from teras.legacy.models import TVAEDecoder
