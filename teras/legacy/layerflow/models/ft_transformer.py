...
@keras.saving.register_keras_serializable("teras.legacy.layerflow.models")
class FTTransformer(keras.Model):
    ...
    Args:
        ...
        numerical_feature_embedding: ``keras.layers.Layer``,
            ...
            You can import the ``FTNumericalFeatureEmbedding`` layer as follows,
                >>> from teras.legacy.layers import FTNumericalFeatureEmbedding
        ...
        cls_token: ``keras.layers.Layer``,
            ...
            You can import the ``FTCLSToken`` layer as follows,
                >>> from teras.legacy.layers import FTCLSToken
    ...
    def __init__(self,
        ...
        if cls_token is None:
            raise ValueError(
                "`cls_token` cannot be None. Please pass an instance of `FTCLSToken` layer. "
                "You can import it as, `from teras.legacy.layers import FTCLSToken`")

        if encoder is None:
            raise ValueError(
                "`encoder` cannot be None. Please pass an instance of `Encoder` layer. "
