...
from teras.legacy.utils.types import LayersCollection
...
class RTDLResNet(keras.Model):
    ...
    Args:
        ...
        resnet_blocks: ``List[layers.Layer]`` or ``models.Model`` or ``keras.layers.Layer``,
            ...
            You can import the ``RTDLResNetBlock`` layer as follows,
                >>> from teras.legacy.layers import RTDLResNetBlock
    ...
    def __init__(self,
        ...
        try:
            ...
            raise TypeError(
                "`resnet_blocks` can either be a list of `RTDLResNetBlock` layers "
    ...
    def get_config(self):
        ...
        config.update({'input_dim': self.input_dim,
                       'resnet_blocks': keras.layers.serialize(
                           self.resnet_blocks),
    ...
    def from_config(cls, config):
        ...
        resnet_blocks = keras.layers.deserialize(
            config.pop("resnet_blocks"))
