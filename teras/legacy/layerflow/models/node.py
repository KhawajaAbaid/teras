...
from teras.legacy.utils.utils import (serialize_layers_collection,
                               deserialize_layers_collection)
from teras.legacy.utils.types import LayersList
...
class NODE(keras.Model):
    ...
    Args:
        ...
        tree_layers: ``List[layers.Layer]``,
            ...
            You can import the `ObliviousDecisionTree` layer as follows,
                >>> from teras.legacy.layers import ObliviousDecisionTree
        ...
        feature_selector: ``keras.layers.Layer``:
            ...
            You can import the ``NodeFeatureSelector`` layer as follows,
                >>> from teras.legacy.layers import NodeFeatureSelector
    ...
    def __init__(self,
        ...
        if not isinstance(tree_layers, (list, tuple)):
            raise ValueError(
                "`tree_layers` must be a list or tuple of `ObliviousDecisionTree` layers, "
