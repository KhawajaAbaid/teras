...
from teras.legacy.losses.gain import generator_loss, discriminator_loss
...
class GAIN(keras.Model):
    ...
    Args:
        generator: ``keras.Model``,
            ...
            You import the standalone ``GAINGenerator`` model as follows,
                >>> from teras.legacy.models import GAINGenerator
        ...
        discriminator: ``keras.Model``,
            ...
            You import the standalone ``GAINDiscriminator`` model as follows,
                >>> from teras.legacy.models import GAINDiscriminator
    ...
    Example:
        ...
        from teras.legacy.utils.gain import inject_missing_values
        ...
        from teras.legacy.preprocessing.gain import DataSampler, DataTransformer
    ...
    def get_config(self):
        ...
        new_config = {'generator': keras.layers.serialize(self.generator),
                      'discriminator': keras.layers.serialize(
                          self.discriminator)
                      }
