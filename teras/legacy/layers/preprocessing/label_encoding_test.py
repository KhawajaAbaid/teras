...
def setup_data():
    df = pd.DataFrame({'player_level': [70, 90, 80, 90, 100, 90, 70, 80],
                       'income': [1000, 1270, 900, 1000, 1234, 5678, 9999,
                                  0],
...
def test_label_encoding_output_shape_when_concatenate_numerical_features_is_false(
        setup_data):
...
def test_label_encoding_output_shape_when_concatenate_numerical_features_is_true(
        setup_data):
    data, metadata = setup_data
    label_encoding = LabelEncoding(features_metadata=metadata,
