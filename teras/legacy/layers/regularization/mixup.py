...
@keras.saving.register_keras_serializable(
    package="teras.legacy.layers.regularization")
class MixUp(keras.layers.Layer):
    ...
    def __init__(self,
        ...
        self.alpha = alpha
        self.lambda_generator = tfp.distributions.Beta(self.alpha,
                                                       self.alpha)
    ...
    def call(self, inputs):
        ...
        inputs_mixedup = (lambda_ * inputs) + (
                    1 - lambda_) * random_partners
