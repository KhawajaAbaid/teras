...
@keras.saving.register_keras_serializable(package="teras.legacy.layers.vime")
class VimeFeatureEstimator(keras.layers.Layer):
    """
    VimeFeatureEstimator layer based on the
