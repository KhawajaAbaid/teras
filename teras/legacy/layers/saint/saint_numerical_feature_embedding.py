...
@keras.saving.register_keras_serializable(package="teras.legacy.layers.saint")
class SAINTNumericalFeatureEmbedding(keras.layers.Layer):
    ...
    def call(self, inputs):
        ...
        for i, (feature_name, feature_idx) in enumerate(
                self.features_metadata["numerical"].items()):
