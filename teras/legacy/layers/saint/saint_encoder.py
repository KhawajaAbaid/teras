...
from teras.legacy.layerflow.layers.saint.saint_encoder import \
...
class SAINTEncoder(_SAINTEncoderLF):
    ...
    def __init__(self,
        ...
        if not apply_attention_to_features and not apply_attention_to_rows:
            raise ValueError(
                "`apply_attention_to_features` and `apply_attention_to_rows` both cannot be False "
        ...
        saint_transformer_layers = keras.models.Sequential(
