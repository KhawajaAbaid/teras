...
from teras.legacy.layerflow.layers.saint.saint_transformer import \
    SAINTTransformer as _SAINTTransformerLF
from teras.legacy.layers.saint.multi_head_inter_sample_attention import \
    MultiHeadInterSampleAttention
from teras.legacy.layers.common.transformer import Transformer, FeedForward
...
class SAINTTransformer(_SAINTTransformerLF):
    ...
    def __init__(self,
        ...
        super().__init__(
            multi_head_inter_sample_attention=multihead_inter_sample_attention,
