...
from teras.legacy.layerflow.layers.common.transformer import (
    FeedForward as _FeedForwardLF,
    Transformer as _TransformerLF,
    Encoder as _EncoderLF)
from teras.legacy.utils.types import ActivationType


@keras.saving.register_keras_serializable(package="teras.legacy.layers.common")
class FeedForward(_FeedForwardLF):
    ...
    Args:
        ...
        activation: default "geglu",
            ...
            You can import it as,
                >>> from teras.legacy.activations import geglu
    """
    ...
    def __init__(self,
                 ...
                 **kwargs):
        hidden_block = keras.models.Sequential(
            name="feed_forward_hidden_block")
    ...
    def get_config(self):
        ...
        if not isinstance(activation_serialized, str):
            activation_serialized = keras.layers.serialize(
...
class Encoder(_EncoderLF):
    ...
    def __init__(self,
                 ...
                 norm_epsilon: float = 1e-6,
                 **kwargs):
        transformer_layers = keras.models.Sequential(
