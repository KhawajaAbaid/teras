...
from teras.legacy.layerflow.models.saint import (SAINT as _SAINTLF,
...
from teras.legacy.layers.regularization import MixUp, CutMix
from teras.legacy.config.saint import SAINTConfig
from teras.legacy.utils.types import UnitsValuesType


@keras.saving.register_keras_serializable("teras.legacy.models")
    ...
    def __init__(self,
        ...
        if features_metadata is None:
            raise ValueError("`features_metadata` cannot be None. "
                             ...
                             "function from teras.legacy.utils.")
...
class SAINTPretrainer(_SAINTPretrainerLF):
    ...
    Args:
        model: ``SAINT``,
            ...
            Using default API, you can import it as,
                >>> from teras.legacy.models import SAINT
            Using LayerFlow API, you can import it as,
                >>> from teras.legacy.layerflow.models import SAINT
    ...
    def __init__(self,
        ...
        num_features = len(features_metadata["categorical"]) + len(
            features_metadata["numerical"])
        ...
        reconstruction_head = SAINTReconstructionHead(
            features_metadata=model.features_metadata,
