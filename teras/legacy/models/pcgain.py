...
from teras.legacy.models.gain import (GAINGenerator as _GAINGenerator,
                               GAINDiscriminator as _GAINDiscriminator,
                               GAIN)
from teras.legacy.utils.types import UnitsValuesType, ActivationType
from teras.legacy.layerflow.models.pcgain import PCGAIN as _PCGAIN_LF
...
class PCGAINGenerator(_GAINGenerator):
    ...
    Args:
        ...
        units_values: ``List[int]`` or ``Tuple[int]``,
            ...
            (``from teras.legacy.layers import GAINGeneratorBlock``)
...
class PCGAINDiscriminator(_GAINDiscriminator):
    ...
    Args:
        ...
        units_values: ``List[int]`` or ``Tuple[int]``,
            ...
            (``from teras.legacy.layers import GAINDiscriminatorBlock``)
...
class PCGAIN(_PCGAIN_LF):
    ...
    Args:
        ...
        generator_units_values: ``List[int]`` or ``Tuple[int]``,
            ...
            (``from teras.legacy.layers import PCGAINGeneratorBlock``)
        ...
        discriminator_units_values: ``List[int]`` or ``Tuple[int]``,
            ...
            For each value, a ``PCGAINDiscriminatorBlock``
            (``from teras.legacy.layers import PCGAINDiscriminatorBlock``)
            of that dimensionality (units) is added to the discriminator
            to form the `hidden block` of the discriminator.
