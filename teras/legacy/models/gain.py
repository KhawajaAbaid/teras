...
from teras.legacy.layers.gain import GAINGeneratorBlock, GAINDiscriminatorBlock
from teras.legacy.layerflow.models.gain import GAIN as _GAIN_LF
...
class GAINGenerator(keras.Model):
    ...
    def __init__(self,
        ...
        if units_values is not None and not isinstance(units_values,
                                                       (list, tuple)):
