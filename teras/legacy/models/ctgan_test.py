...
from teras.legacy.models.ctgan import CTGANGenerator, CTGANDiscriminator, CTGAN
...
class CTGANGeneratorTest(tf.test.TestCase):
    def setUp(self):
        ...
        self.data_transformer = CTGANDataTransformer(
        ...
        self.dataset = self.data_sampler.get_dataset(
