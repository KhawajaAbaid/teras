...
from teras.legacy.layerflow.models.tvae import TVAE as _TVAE_LF
...
class TVAEEncoder(keras.Model):
    ...
    def __init__(self,
        ...
        self.compression_block = keras.models.Sequential(
...
class TVAEDecoder(keras.Model):
    ...
    def __init__(self,
        ...
        self.decompression_block = keras.models.Sequential(
            name="decompression_block")
        for i, units in enumerate(self.units_values, start=1):
        ...
        self.decompression_block.add(
            keras.layers.Dense(units=self.data_dim,
                               name="projection_to_data_dim"))

        self.sigmas = tf.Variable(initial_value=keras.initializers.ones()(
            shape=(self.data_dim,)) * 0.1,
                                  trainable=True,
                                  name="sigmas")
