...
from teras.legacy.preprocessing.pcgain import PCGAINDataSampler, \
    PCGAINDataTransformer
from teras.legacy.utils import inject_missing_values, generate_fake_gemstone_data
import os
import pytest
...
class GAINTest(tf.test.TestCase):
    def setUp(self):
        ...
        self.data_transformer = PCGAINDataTransformer(
            numerical_features=numerical_cols,
            categorical_features=categorical_cols)
        x_transformed = self.data_transformer.fit_transform(x_with_missing,
        ...
        self.x_pretrain = self.data_sampler.get_pretraining_dataset(
            x_transformed, pretraining_size=0.3)
    ...
    def test_fit(self):
        ...
        self.pcgain_imputer.pretrain(self.x_pretrain,
                                     pretrainer_fit_kwargs,
                                     classifier_fit_kwargs)
        self.pcgain_imputer.fit(self.x_train)

    def test_impute(self):
        imputed_data = self.pcgain_imputer.impute(self.x_test,
