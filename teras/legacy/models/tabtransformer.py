...
from teras.legacy.config.tabtransformer import TabTransformerConfig
from teras.legacy.layerflow.models.tabtransformer import \
    TabTransformer as TabTransformerLF
from teras.legacy.layers.common.transformer import Encoder
...
from teras.legacy.layers.common.head import ClassificationHead, RegressionHead
from teras.legacy.utils.types import UnitsValuesType, NormalizationType
...
"""
    ...
    def __init__(self,
        ...
        if features_metadata is None:
            ...
            `teras.legacy.utils.get_categorical_features_vocabulary(dataset, categorical_features, numerical_features)`
        ...
        numerical_feature_normalization = NumericalFeatureNormalization(
            features_metadata=features_metadata,
    ...
    def get_config(self):
        ...
        if not isinstance(numerical_normalization_serialized, str):
            numerical_normalization_serialized = keras.layers.serialize(
                numerical_normalization_serialized)
