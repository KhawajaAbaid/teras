...
from teras.legacy.layerflow.models.vime import (VimeSelf as _VimeSelfLF,
...
class VimeSelf(_VimeSelfLF):
    ...
    def get_config(self):
        ...
        if not isinstance(encoder_activation_serialized, str):
            encoder_activation_serialized = keras.layers.serialize(
                encoder_activation_serialized)
        ...
        if not isinstance(feature_estimator_activation_serialized, str):
            feature_estimator_activation_serialized = keras.layers.serialize(
                feature_estimator_activation_serialized)
        ...
        if not isinstance(mask_estimator_activation_serialized, str):
            mask_estimator_activation_serialized = keras.layers.serialize(
                mask_estimator_activation_serialized)
