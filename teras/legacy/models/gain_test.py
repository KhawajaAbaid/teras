...
from teras.legacy.models.gain import GAINGenerator, GAINDiscriminator, GAIN
from teras.legacy.preprocessing.gain import GAINDataSampler, GAINDataTransformer
...
class GAINTest(tf.test.TestCase):
    def setUp(self):
        ...
        self.data_transformer = GAINDataTransformer(
    ...
    def test_impute(self):
        imputed_data = self.gain_imputer.impute(self.x_test,
