from teras.legacy.models.tabnet import TabNetClassifier, TabNetRegressor, \
    TabNetPretrainer, TabNet
...
class TabNetPretrainerTest(tf.test.TestCase):
    def setUp(self):
        ...
        self.data_batch = data.values
        self.mask = self.binary_mask_generator.sample(
            self.data_batch.shape)
